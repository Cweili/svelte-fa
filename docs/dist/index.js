(function (svelteFa) {
  ...
  /** @type {const} */
  ['allowfullscreen', 'allowpaymentrequest', 'async', 'autofocus', 'autoplay', 'checked', 'controls', 'default', 'defer', 'disabled', 'formnovalidate', 'hidden', 'inert', 'ismap', 'loop', 'multiple', 'muted', 'nomodule', 'novalidate', 'open', 'playsinline', 'readonly', 'required', 'reversed', 'selected'];
  /**
  ...
  function create_fragment$c(ctx) {
    ...
    var mounted;
    var dispose;
    var each_value_2 = ensure_array_like(
    /*pull*/
    ctx[1]);
    ...
    var each_value_1 = ensure_array_like(
    /*flip*/
    ctx[2]);
  ...
  function create_fragment$9(ctx) {
    ...
    docscode0 = new DocsCode({
      props: {
        code: codes.additionalStyling[0]
      }
    });
    ...
    docscode1 = new DocsCode({
      props: {
        code: codes.additionalStyling[1]
      }
    });
    ...
    docscode2 = new DocsCode({
      props: {
        code: codes.additionalStyling[2]
      }
    });
    return {
      c: function c() {
  ...
  } // (37:2) <FaLayers size="4x" style="background: mistyrose">
  ...
  } // (57:4) <FaLayersText       scale={0.45}       translateY={0.1}       color="white"       style="font-weight: 900"     >
  ...
  } // (55:2) <FaLayers size="4x" style="background: mistyrose">
  ...
  } // (68:4) <FaLayersText       scale={0.25}       rotate={-30}       color="white"       style="font-weight: 900"     >
  ...
  } // (66:2) <FaLayers size="4x" style="background: mistyrose">
  ...
  } // (79:4) <FaLayersText       scale={0.2}       translateX={0.4}       translateY={-0.4}       color="white"       style="padding: 0 .2em; background: tomato; border-radius: 1em"     >
  ...
  } // (77:2) <FaLayers size="4x" style="background: mistyrose">
  ...
  function create_fragment$3(ctx) {
    ...
    docscode0 = new DocsCode({
      props: {
        code: codes.layering[0],
        lang: "js"
      }
    });
    docscode1 = new DocsCode({
      props: {
        code: codes.layering[1]
      }
    });
    return {
      c: function c() {
